...
class _ModuleTiles extends StatelessWidget {
  ...
  static const _moduleTiles = <_ModuleTileSpec>[
    _ModuleTileSpec(['calendar'], 'module-tile-calendar',
        Icons.event_outlined),
    _ModuleTileSpec(['coffee'], 'module-tile-coffee', Icons.coffee_outlined),
    _ModuleTileSpec(['checklists'], 'module-tile-checklists',
        Icons.checklist_outlined),
    _ModuleTileSpec(['defects'], 'module-tile-defects',
        Icons.report_problem_outlined),
    _ModuleTileSpec(['assets', 'inventory'], 'module-tile-assets',
        Icons.directions_car_outlined),
    _ModuleTileSpec(['reports'], 'module-tile-reports',
    ...
    _ModuleTileSpec(['pinboard'], 'module-tile-pinboard',
